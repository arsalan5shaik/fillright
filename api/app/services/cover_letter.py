...
def generate_cover_letter(
    ...
    *,
    ...
    prompt = (
        ...
        "dates, or accomplishments they don't have. Keep it concise: 2-3 "
        "paragraphs total, no more than about 200 words, professional "
        "tone, no generic filler, no placeholder brackets.\n\n"
